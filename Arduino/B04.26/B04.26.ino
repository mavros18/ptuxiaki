...
const char sensorName05[] PROGMEM = "light[V]";
...
void serialEvent() {
  Serial.println(F("D3ebug: serialEvent"));
...
void requestData() {
  Serial.println("D1ebug: requestEvent " + String(_sensor_num_));
